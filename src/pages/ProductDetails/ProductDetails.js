...
//     console.log("Product Details: ", dataDetails)

//   }

//   console.log("data24", dataDetails)
...
//               <p className='bg-violet-300 animate-pulse text-blue-600 px-5 rounded-full inline-block w-fit '></p>
//               <h2 className='text-2xl font-semibold'>{dataDetails?.productName}</h2>
//               <p className='capitalize text-slate-500'>Category: {dataDetails?.productsCategory}</p>
//               <p className='font-bold'>Price: {displayNGNCurrency(dataDetails?.productPrice)}</p>
//               <p className='text-red-500 line-through text-sm'>Discount: {displayNGNCurrency(dataDetails?.productDiscount)}</p>
...
//                 <button className='border-2 px-3 py-1 min-w-[120px] rounded bg-gradient-to-r from-violet-600 to-blue-600 text-white-500 hover:text-red-500'>Buy</button>
//                 <button className='border-2 px-3 py-1 min-w-[120px] rounded bg-gradient-to-r from-violet-600 to-blue-600 text-white-500 hover:text-red-500 transition-all'>Add to Cart</button>
//               </div>
//               <div className='flex items-center gap-3 my-2'>
//                 {/* Add to wishlist button */}
//                 <button className='border-2 px-3 py-1 min-w-[120px] rounded-2xl bg-gradient-to-r from-blue-600 to-violet-600 text-white-500 hover:text-blue-800 inline-block w-fit'>Add to Wishlist</button>
//                 {/* Share button */}
//                 <button className='border-2 px-3 py-1 min-w-[120px] rounded-2xl bg-gradient-to-r from-blue-600 to-violet-600 text-white-500 hover:text-blue-800 inline-block w-fit'>Share</button>
//               </div>
//               {/* Review button */}
...
//           ) : (
//             <div className='flex flex-col gap-1'>
//               <p className='bg-violet-300 text-blue-600 px-2 rounded-full inline-block w-fit'>Brand: {dataDetails?.productBrand}</p>
//               <h2 className='text-2xl font-semibold'>{dataDetails?.productName}</h2>
//               <p className='capitalize text-slate-500'>Category: {dataDetails?.productsCategory}</p>
//               <p className='font-bold'>Price: {displayNGNCurrency(dataDetails?.productPrice)}</p>
//               <p className='text-red-500 line-through text-sm'>Discount: {displayNGNCurrency(dataDetails?.productDiscount)}</p>
...
//         <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
//           <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 flex items-center justify-center'>
//             {loading ? (
...
//               <button className='px-6 py-2 rounded bg-gradient-to-r from-violet-600 to-blue-600 text-white hover:opacity-90 transition-all'>
//                 Buy Now
//               </button>
//               <button className='px-6 py-2 rounded border-2 border-violet-600 text-violet-600 hover:bg-violet-100 transition-all'>
//                 Add to Cart
//               </button>
