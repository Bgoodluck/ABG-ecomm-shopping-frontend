...
// // {
// //   `Product list for category: ${params?.categoryName}` && (
// //     <CategorySearchDisplay productsCategory={params?.categoryName} heading={"Recommended Products"}/>
// //   )
...
//     // just create a new sorted array instead of mutating the state directly
...
//             <div className='bg-slate-200 p-2 min-h-[calc(100vh-120px)] overflow-y-scroll'>
//                 <div className=''>
//                    <h3 className='text-base uppercase font-medium text-slate-800 border-b pb-1 border-slate-400'>Sort by</h3>
...
//                 <div className=''>
//                    <h3 className='text-base uppercase font-medium text-slate-800 border-b pb-1 border-slate-400'>Category</h3>
